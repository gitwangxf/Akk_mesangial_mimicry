...
A bioinformatics pipeline designed to identify molecular mimicry pairs between _Akkermansia muciniphila_ (Akk) microbial proteins and human mesangial cell host proteins. By integrating immunology predictors with 3D structural alignment tools (Foldseek), this framework screens for bacterial epitopes capable of driving cross-reactive autoimmune responses.
